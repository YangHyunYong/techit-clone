...
import SilderBannerCard from "./SlideBannerCard";
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 max-w-[1280px] w-full px-6">
        <div className="flex bg-black bg-opacity-30 w-fit text-white text-xs rounded-full gap-2 px-3 py-[5px]">
          <div>{page + 1} / 8</div>{" "}
          <button onClick={onClickPrev} title="prev">
            <svg
          ...
          <button onClick={onClickNext} title="next">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
